...
namespace Diiwo.Identity.App.Seeders;

/// <summary>
/// Independent seeder for App Identity architecture
...
public static class AppSeeder
{
    ...
    /// </summary>
    /// <param name="context">App Identity DbContext</param>
    ...
    private static async Task SeedRolesAsync(AppIdentityDbContext context)
    {
    ...
    private static async Task SeedPermissionsAsync(AppIdentityDbContext context)
    {
    ...
    private static async Task SeedRolePermissionsAsync(AppIdentityDbContext context)
    {
