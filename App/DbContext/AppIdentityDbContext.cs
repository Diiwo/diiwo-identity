...
public class AppIdentityDbContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    private void SeedDefaultData(ModelBuilder modelBuilder)
    {
        ...
        {
            new AppRolePermission { Id = Guid.Parse("r1111111-1111-1111-1111-111111111111"), RoleId = Guid.Parse("11111111-1111-1111-1111-111111111111"), PermissionId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new AppRolePermission { Id = Guid.Parse("r2222222-2222-2222-2222-222222222222"), RoleId = Guid.Parse("11111111-1111-1111-1111-111111111111"), PermissionId = Guid.Parse("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new AppRolePermission { Id = Guid.Parse("r3333333-3333-3333-3333-333333333333"), RoleId = Guid.Parse("11111111-1111-1111-1111-111111111111"), PermissionId = Guid.Parse("cccccccc-cccc-cccc-cccc-cccccccccccc"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new AppRolePermission { Id = Guid.Parse("r4444444-4444-4444-4444-444444444444"), RoleId = Guid.Parse("11111111-1111-1111-1111-111111111111"), PermissionId = Guid.Parse("dddddddd-dddd-dddd-dddd-dddddddddddd"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            
            // Admin gets read/write permissions
            new AppRolePermission { Id = Guid.Parse("r5555555-5555-5555-5555-555555555555"), RoleId = Guid.Parse("22222222-2222-2222-2222-222222222222"), PermissionId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new AppRolePermission { Id = Guid.Parse("r6666666-6666-6666-6666-666666666666"), RoleId = Guid.Parse("22222222-2222-2222-2222-222222222222"), PermissionId = Guid.Parse("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            
            // User gets read permissions
            new AppRolePermission { Id = Guid.Parse("r7777777-7777-7777-7777-777777777777"), RoleId = Guid.Parse("33333333-3333-3333-3333-333333333333"), PermissionId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new AppRolePermission { Id = Guid.Parse("r8888888-8888-8888-8888-888888888888"), RoleId = Guid.Parse("33333333-3333-3333-3333-333333333333"), PermissionId = Guid.Parse("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), IsGranted = true, Priority = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow }
        };
